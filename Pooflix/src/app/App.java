...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ahora epiDemo apunta a objeto Websodio. Puedo hacerlo porque es una variable de una clase en comun.
        // En tiempo de ejecucion el programa va a saber si está apuntando a objeto Episodio o Websodio.
        epiDemo = temporadaElegida.getEpisodioAtPosicion(posicion);

        epiDemo.reproducir();

        // 1- preguntar de que tipo es. Usando el operador "instanceof"
        // 2-castearlo al tipo correspondiente (aka "transformarlo") usando el operador de Casteo. Asi podemos usar el metodo de Webisodio
        ...
        //El primero es una pelicula
        //el segundo es una actor
        miPooflix.getNominados().get(0).estaNominada();
        miPooflix.getNominados().get(4).estaNominada();
